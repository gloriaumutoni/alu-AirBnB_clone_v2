...
| 6. Console 0.0.1              | [console.py](https://github.com/AristideI/AirBnB_clone/blob/dev/console.py)                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Add basic functionality to console program, allowing it to quit, handle empty lines and ^D          |
